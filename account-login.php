...
<head>
    ...
    <title><?php echo $thename?> | Your Account Login</title>
    ...
    <meta name="description" content="Login to your Account and book rides faster by using your stored account information, view your reservations, Access invoices, and payment receipts and generate Reporting tools."/>

    <meta property="og:title" content="<?php echo $thename?> | Your Account Login" />
    <meta property="og:image" content="<?php echo $website?>/all-images/plugin-pix/1st-classic.jpg"/>
    <meta property="og:description" content="Login to your Account and book rides faster by using your stored account information, view your reservations, Access invoices, and payment receipts and generate Reporting tools."/>

    <meta name="twitter:title" content="<?php echo $thename?> | Your Account Login"/> 
    <meta name="twitter:card" content="<?php echo $thename?>"/> 
    <meta name="twitter:image"  content="<?php echo $website?>/all-images/plugin-pix/1st-classic.jpg"/> 
    <meta name="twitter:description" content="Login to your Account and book rides faster by using your stored account information, view your reservations, Access invoices, and payment receipts and generate Reporting tools."/>
</head>
...
<body>
    ...
    <section class="no-cont-others-pg-div">
        <section class="body-div">
            ...
            <a href="https://book.mylimobiz.com/v4/1stclassic/Account/LoginNow" data-ores-widget="website" data-ores-alias="1stclassic/Account/LoginNow"></a>

...
<?php include 'meta.php'?>
    <title><?php echo $thename?> | Create Account</title>
    ...
    <meta name="description" content="Create an Account and book rides faster by using your stored account information View your reservations, Access invoices, and payment receipts and generate Reporting tools."/>

    <meta property="og:title" content="<?php echo $thename?> | Create Account" />
    <meta property="og:image" content="<?php echo $website?>/all-images/plugin-pix/1st-classic.jpg"/>
    <meta property="og:description" content="Create an Account and book rides faster by using your stored account information View your reservations, Access invoices, and payment receipts and generate Reporting tools."/>

    <meta name="twitter:title" content="<?php echo $thename?> | Create Account"/> 
    <meta name="twitter:card" content="<?php echo $thename?>"/> 
    <meta name="twitter:image"  content="<?php echo $website?>/all-images/plugin-pix/1st-classic.jpg"/> 
    <meta name="twitter:description" content="Create an Account and book rides faster by using your stored account information View your reservations, Access invoices, and payment receipts and generate Reporting tools."/>
</head>
...
<body>
    ...
    <section class="no-cont-other-pages">
        <div class="other-pages-back-div">
            <div class="text-content-div" data-aos="fade-in" data-aos-duration="900">
                <h1 data-aos="fade-in" data-aos-duration="800"><span>Sign-Up to Create Account</h1>
                
                <div class="btn-div">
                    <a href="<?php echo $website_url?>" title="Book A Limo Now!">
                    <button class="btn" title="Start as a student">Book A Limo Now! <i class="bi-chevron-right"></i></button></a>
    ...
    <section class="no-cont-others-pg-div">
        <section class="body-div">
            <div class="body-div-in">
                <a href="https://book.mylimobiz.com/v4/1stclassic/Account/Registration" data-ores-widget="website" data-ores-alias="1stclassic/Account/Registration"></a>
